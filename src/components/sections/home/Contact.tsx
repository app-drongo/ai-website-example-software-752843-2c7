...
const DEFAULT_CONTACT = {
  ...
  mainTitleHighlight: 'Business?',
  mainDescription:
    "Join thousands of companies already using our software to streamline operations and boost productivity. Let's discuss how we can help you achieve your goals.",
  formTitle: 'Start Your Free Trial',
  formDescription: "Tell us about your needs and we'll set up a personalized demo within 24 hours.",
  ...
  method1Contact: 'sales@examplesoftware.com',
  method2Title: 'Product Demo',
  method2Description: 'Schedule a live walkthrough',
  method2Contact: '+1 (555) 847-2100',
  method3Title: 'Live Support',
  method3Description: 'Get instant help',
  method3Contact: 'Available 9 AM - 6 PM EST',
  officesSectionTitle: 'Global Presence',
  office1City: 'San Francisco',
  office1Address: '350 Mission Street, Suite 2800',
  office1Timezone: 'PST (UTC-8)',
  office2City: 'Austin',
  office2Address: '98 San Jacinto Blvd, Suite 1500',
  office2Timezone: 'CST (UTC-6)',
  office3City: 'Toronto',
  office3Address: '181 Bay Street, Suite 3000',
  ...
  supportNote: 'Priority support & 24/7 uptime monitoring for Enterprise plans',
  nameLabel: 'Full Name *',
  ...
  messagePlaceholder:
    'What challenges are you looking to solve? How many team members would use the software?',
} as const;
