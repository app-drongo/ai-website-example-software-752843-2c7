...
const DEFAULT_HERO = {
  badge: 'New: Smart Automation Suite',
  title: 'Transform your workflow with',
  titleHighlight: 'intelligent software solutions',
  description:
    'Streamline operations, boost productivity, and scale your business with our cutting-edge automation platform designed for modern enterprises.',
  features: [
  ...
  statsLabel2: 'Cost Savings',
  statsValue2: '40% reduction',
} as const;
