...
const DEFAULT_FOOTER = {
  logoText: 'Example Software',
  companyDescription:
    'Empowering businesses with cutting-edge software solutions and enterprise-grade applications. Trusted by over 10,000 companies worldwide to streamline operations and drive digital transformation.',
  contactEmail: 'contact@examplesoftware.com',
  contactPhone: '+1 (555) 847-2100',
  contactAddress: '2500 Technology Drive, Suite 400, San Francisco, CA',
  newsletterTitle: 'Developer Updates',
  newsletterPlaceholder: 'Enter your email address',
  newsletterDisclaimer:
    'Get weekly insights on software development trends and product updates. Unsubscribe anytime.',
  section1Title: 'Platform',
  section2Title: 'Company',
  section3Title: 'Resources',
  section4Title: 'Legal',
  copyrightText: '© 2024 Example Software. All rights reserved.',
  madeWithText: 'by our engineering team',
  socialText: 'Connect with us:',
  social1Href: 'https://twitter.com/examplesoftware',
  social2Href: 'https://facebook.com/examplesoftware',
  social3Href: 'https://instagram.com/examplesoftware',
  social4Href: 'https://linkedin.com/company/examplesoftware',
  social5Href: 'https://github.com/examplesoftware',
} as const;
  ...
  const footerSections = [
    {
      ...
      links: [
        { name: 'API Gateway', href: '/api-gateway', editableId: 'link-footer-api-gateway' },
        ...
        { name: 'Security Suite', href: '/security', editableId: 'link-footer-security-suite' },
        { name: 'Developer Tools', href: '/dev-tools', editableId: 'link-footer-dev-tools' },
    ...
    },
    {
      ...
      links: [
        { name: 'About Us', href: '/', editableId: 'link-footer-about' },
        ...
        { name: 'Technology Partners', href: '/partners', editableId: 'link-footer-partners' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Developer Community', href: '/community', editableId: 'link-footer-community' },
        { name: 'Code Examples', href: '/examples', editableId: 'link-footer-examples' },
        { name: 'Technical Webinars', href: '/webinars', editableId: 'link-footer-webinars' },
        { name: 'Implementation Guides', href: '/guides', editableId: 'link-footer-guides' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'GDPR Compliance', href: '/gdpr', editableId: 'link-footer-gdpr' },
        {
          ...
          editableId: 'link-footer-security-standards',
        },
        { name: 'Audit Reports', href: '/audits', editableId: 'link-footer-audits' },
      ],
    },
  ];
